...
- [x] Cambiar palabra mergear por unificar
...
- [x] Testear caso en el que si cambia el archivo de input, cambien los archivos generados en una siguiente ejecución
